...
class Order(models.Model):
    ...
    shipping_total = models.DecimalField(default = Decimal('5.99'), max_digits = 100, decimal_places = 2)
    ...
    def check_done(self):
        ...
        total = self.total
        # Verifica se todos os campos necessários estão presentes e o total é maior que zero
